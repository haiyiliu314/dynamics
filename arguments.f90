...
!                                                 sigmat_A = 0.2d0*scale1, tstart_A = -0.5d0*scale1  
  ...
  !physical parameters
  double precision, parameter                  ::Ebind = 4.18d0, gamma = 0d0, Eg = 1.50d3
  double precision, parameter                  ::omega_1s = (-4d0*Ebind + Eg)/hbar, &    
                                                 A_freq_para = Eg*0.5d0/hbar, dipole = 5d-10*e
...
!                                                 A_freq_para = omega_1s
  ...
  double precision, parameter                  ::E_excit = 1.0d-3, A_excit = 40d-3/Ebind, shift = 4.0d0
